            ...
            <div className="relative h-80 w-full max-w-md lg:h-96">
              ...
              <div className="absolute inset-6 flex flex-col gap-3">
                {[
                  ...
                  <div
                    key={i}
                    className={`${bar.h} ${bar.w} rounded-full bg-white/10`}
                  />
                ))}
                <div className="mt-4 h-24 w-full rounded-xl bg-gradient-to-r from-accent-purple/30 to-accent-cyan/30 border border-white/10" />
              </div>
            </div>
          </div>
        </section>
